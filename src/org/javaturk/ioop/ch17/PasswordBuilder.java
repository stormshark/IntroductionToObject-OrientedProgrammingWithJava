...
public class PasswordBuilder {   
    ...
    public String makePassword(String[] args){
        ...
        char firstOfName = args[0].charAt(0);   sb.append(Character.toUpperCase(firstOfName));
        char firstOfAge = args[2].charAt(0);    sb.append(firstOfAge);       
        int random = (int) (100 * Math.random()); sb.append(random);
        ...
        random = (int) (100 * Math.random());     sb.append(random);
